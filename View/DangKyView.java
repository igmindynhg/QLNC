...
public class DangKyView extends javax.swing.JPanel {
    ...
    public NguoiDungModel checkDangKy() {
        NguoiDungModel userDK = new NguoiDungModel(txtTen.getText(),txtTaiKhoan.getText(),String.valueOf(txtpw1.getPassword()));
//        NguoiDungModel userLogin = new NguoiDungModel(txtTaiKhoan.getText(), txtTen.getText(), String.valueOf(txtpw1.getPassword()));
    ...
    private void btnTaoTaiKhoanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTaoTaiKhoanActionPerformed
        ...
        JOptionPane.showMessageDialog(jButton1, "Mật khẩu không khớp");
        }
