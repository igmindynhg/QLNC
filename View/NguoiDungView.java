...
public class NguoiDungView extends javax.swing.JPanel {
    ...
    public final void setTT(NguoiDungModel nd) {
        ...
        txtCanCuocCongDan.setText(nd.getCanCuocCongDan());
...
public NguoiDungModel getThongTin(){
    ...
    String canCuocCongDan = txtCanCuocCongDan.getText();
    String soDienThoai = txtSoDienThoai.getText();
    String vaiTro = txtVaiTro.getText();
    return new NguoiDungModel(hoTen, email, diaChi, canCuocCongDan, soDienThoai,NguoiDungController.ndOn.getTaiKhoan(),NguoiDungController.ndOn.getMatKhau(),vaiTro);
}
    ...
    JOptionPane.showMessageDialog(jPanel1, hi ,"Thông báo",JOptionPane.ERROR_MESSAGE);
    }
   public void Thongbao1(String hi){
    JOptionPane.showMessageDialog(jPanel1, hi ,"Thông báo",JOptionPane.INFORMATION_MESSAGE);
    }
...
//        JOptionPane.showMessageDialog(this, "Lưu thành công!", "Thông báo", JOptionPane.YES_NO_CANCEL_OPTION);
        // TODO add your handling code here:
